                        ...
                        <div className="p-6 md:p-8 flex flex-col justify-between flex-1">
                            <div>
                                ...
                                <p className="text-base text-slate-805 max-w-2xl font-google-text leading-relaxed mb-6 font-medium">
                                    Organized by GDG on Campus at UW-Green Bay in collaboration with 404 Network and in partnership with MLH, HackGB is a historic 24-hour hackathon experience. We invite 200+ students to embark on a mythical coding journey at the STEM Innovation Center — where the Phoenix rises.
                                </p>
                            </div>
