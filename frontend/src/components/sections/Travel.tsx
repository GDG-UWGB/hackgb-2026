            ...
            <div className='mx-auto max-w-7/8 mt-16'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-14 h-auto lg:h-[85vh]'>
                    ...
                    <div className='flex flex-col gap-6 lg:h-full'>
                        <div className='bg-google-green-darktone text-white rounded-full py-10 lg:py-0 flex flex-col justify-center items-center lg:flex-1 text-center shadow-md font-google font-bold text-3xl md:text-2xl 2xl:text-3xl leading-snug'>
                            <h2>UW Green Bay</h2>
