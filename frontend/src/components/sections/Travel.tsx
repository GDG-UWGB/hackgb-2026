    ...
    return (
        <section className='py-24 bg-transparent'>
            ...
            <div className='max-w-7/8 lg:max-w-6/8 mx-auto'>
                <div className='flex items-center gap-6 mb-16 text-4xl lg:text-5xl font-google'>
                    {/* Location icon */}
                    <span className="lg:text-4xl text-[#E37100]"><FontAwesomeIcon icon={faLocationDot} /></span>
                    <h2 className='text-slate-900'>How to get here</h2>
                </div>
                <div className='flex flex-col lg:flex-row gap-8 lg:gap-14 text-lg text-slate-600 font-google-text leading-relaxed'>
            ...
            <div className='mx-auto max-w-7/8 mt-16'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-14 h-auto lg:h-[85vh]'>
                    ...
                    <div className="relative min-h-[400px] lg:col-span-2 lg:min-h-0 border border-black/5 rounded-[2.5rem] overflow-hidden shadow-md">
                        <iframe
                        ...
                        <div className="absolute bottom-6 left-6 z-10">
                            <a
                                ...
                                className="flex items-center gap-2 bg-[#61A644] hover:bg-[#61A644]/90 text-white px-5 py-2.5 rounded-full font-medium transition-colors shadow-md text-sm md:text-base"
                            >
                                Get directions
                    ...
                    <div className='flex flex-col gap-6 lg:h-full'>
                        <div className='bg-white/70 border border-black/5 text-slate-800 rounded-[2.5rem] py-10 lg:py-0 flex flex-col justify-center items-center lg:flex-1 text-center shadow-md font-google font-bold text-3xl md:text-2xl 2xl:text-3xl leading-snug backdrop-blur-md'>
                            <h2>UW Green Bay</h2>
                        ...
                        <div className='lg:flex-1 hidden md:block'>
                            <ImageMask
                                ...
                                altText="UWGB Campus"
                                aspectRatio="1/1"
                                className='w-full lg:h-full object-contain brightness-90 hover:brightness-100 transition-all duration-300'
                            />
                        </div>
                    </div>
                </div>
