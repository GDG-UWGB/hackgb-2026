...
const GOOGLE_FORM_URL = 'https://docs.google.com/forms/d/e/1FAIpQLSeeiVPYX3knnwOzCyelEUnt4uIjTM-rcAXco8JEAf71YxJfUg/formResponse';
...
const MentorApplication = () => {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    setFormData((prev) => {
      ...
      if (name === 'mentoredBefore' && value !== 'Yes') {
        nextState.mentoredHackathons = '';
      }
      return nextState;
    });
    if (errors[name]) {
  ...
  const validateStep = (currentStep: number): boolean => {
    ...
    if (currentStep === 1) {
      ...
      if (!formData.organization.trim()) newErrors.organization = 'Organization / Company is required.';
    ...
    if (currentStep === 2) {
      ...
      if (!formData.comfortableArea) newErrors.comfortableArea = 'Please select a preferred mentoring area.';
      if (!formData.mentoredBefore) newErrors.mentoredBefore = 'This field is required.';
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      data.append('entry.686031745', formData.mentoredBefore);
      data.append('entry.783278815', formData.mentoredBefore === 'Yes' ? formData.mentoredHackathons : '');
  ...
  return (
    <main className="relative min-h-screen pt-28 pb-20 px-4 overflow-hidden bg-transparent flex flex-col items-center justify-center">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <img src={downtownImg} alt="" className="w-full h-full object-cover opacity-[0.25] parallax-bg" />
        <div className="absolute inset-0 bg-[#5746e3]/[0.01]" />
      </div>

      {/* Ambient glow */}
      <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-[#5746e3]/5 rounded-full blur-[120px] pointer-events-none" />
        ...
        <AnimatePresence mode="wait">
          {!isSuccess ? (
            <motion.div
              ...
              className="bg-white/45 backdrop-blur-xl rounded-2xl border border-white/25 shadow-2xl overflow-hidden flex flex-col min-h-[500px]"
            >
              {/* IDE Top Window Bar */}
              <div className="flex items-center justify-between px-4 py-2 border-b border-black/5 bg-white/30 select-none">
                ...
                <div className="flex items-center gap-1.5 font-google-mono text-[9px] text-[#5746e3] font-bold bg-[#5746e3]/10 px-2 py-0.5 rounded border border-[#5746e3]/25">
                  <Terminal className="w-3.5 h-3.5" />
                  <span>mentor_setup.js</span>
                </div>
              </div>

              {/* Editor Tab Bar */}
              <div className="flex border-b border-black/5 bg-white/20 select-none">
                {steps.map((s) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-2 px-5 py-3 border-r border-black/5 font-google-mono text-[11px] font-medium transition-all flex-1 justify-center whitespace-nowrap ${
                        isActive
                          ? 'bg-white/60 text-[#0C3C34] border-t-2 border-t-[#5746e3]'
                          : isCompleted
                          ? 'text-[#5746e3] hover:bg-white/30 cursor-pointer'
                          : 'text-slate-400 bg-transparent cursor-not-allowed'
                      }`}
                    >
                      <FontAwesomeIcon icon={s.icon} className={isActive ? 'text-[#5746e3]' : ''} />
                      <span className="hidden sm:inline">{s.name}</span>
                      {isCompleted && (
                        <div className="w-3.5 h-3.5 rounded-full bg-[#5746e3]/15 text-[#5746e3] flex items-center justify-center text-[9px]">
              ...
              <div className="p-6 sm:p-10 flex-1 flex flex-col justify-between">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-5">
                          ...
                          <div className="flex flex-col md:flex-row gap-4">
                            <div className="flex-1 flex flex-col gap-1.5">
                              ...
                              <input
                                ...
                                className={`px-4 py-3 rounded-xl border bg-white/70 text-slate-800 placeholder-slate-400 font-google-text text-sm focus:outline-none focus:border-[#5746e3] focus:ring-1 focus:ring-[#5746e3]/20 transition-all ${
                          ...
                          <div className="flex flex-col md:flex-row gap-4">
                            ...
                            <div className="flex-1 flex flex-col gap-1.5">
                              ...
                              <input
                                ...
                                className={`px-4 py-3 rounded-xl border bg-white/70 text-slate-800 placeholder-slate-400 font-google-text text-sm focus:outline-none focus:border-[#5746e3] focus:ring-1 focus:ring-[#5746e3]/20 transition-all ${
                                  errors.cityState ? 'border-red-500 focus:border-red-500 focus:ring-red-200' : 'border-black/10'
                                }`}
                              />
                          ...
                          <div className="flex flex-col md:flex-row gap-4">
                            <div className="flex-1 flex flex-col gap-1.5">
                              ...
                              <input
                                ...
                                className={`px-4 py-3 rounded-xl border bg-white/70 text-slate-800 placeholder-slate-400 font-google-text text-sm focus:outline-none focus:border-[#5746e3] focus:ring-1 focus:ring-[#5746e3]/20 transition-all ${
                                  errors.organization ? 'border-red-500 focus:border-red-500 focus:ring-red-200' : 'border-black/10'
                                }`}
                              />
                            ...
                            <div className="flex-1 flex flex-col gap-1.5">
                              ...
                              <input
                                ...
                                className={`px-4 py-3 rounded-xl border bg-white/70 text-slate-800 placeholder-slate-400 font-google-text text-sm focus:outline-none focus:border-[#5746e3] focus:ring-1 focus:ring-[#5746e3]/20 transition-all ${
                                  errors.role ? 'border-red-500 focus:border-red-500 focus:ring-red-200' : 'border-black/10'
                                }`}
                              />
                          ...
                          <div className="flex flex-col gap-1.5">
                            ...
                            <input
                              ...
                              className="px-4 py-3 rounded-xl border border-black/10 bg-white/70 text-slate-800 placeholder-slate-400 font-google-text text-sm focus:outline-none focus:border-[#5746e3] focus:ring-1 focus:ring-[#5746e3]/20 transition-all"
                            />
                          </div>
                        </div>
                      )}
                      ...
                      {step === 2 && (
                        ...
                        <div className="flex flex-col gap-5 overflow-y-auto max-h-[420px] pr-2">
                          ...
                          <div className="flex flex-col md:flex-row gap-4">
                            <div className="flex-1 flex flex-col gap-1.5">
                              ...
                              <select
                                ...
                                onChange={handleInputChange}
                                className={`px-4 py-3 rounded-xl border bg-white/70 text-slate-800 font-google-text text-sm focus:outline-none focus:border-[#5746e3] focus:ring-1 focus:ring-[#5746e3]/20 transition-all ${
                                  errors.professionalStatus ? 'border-red-500 focus:border-red-500' : 'border-black/10'
                                }`}
                              >
                            ...
                            <div className="flex-1 flex flex-col gap-1.5">
                              ...
                              <select
                                ...
                                onChange={handleInputChange}
                                className={`px-4 py-3 rounded-xl border bg-white/70 text-slate-800 font-google-text text-sm focus:outline-none focus:border-[#5746e3] focus:ring-1 focus:ring-[#5746e3]/20 transition-all ${
                                  errors.yearsExperience ? 'border-red-500 focus:border-red-500' : 'border-black/10'
                                }`}
                              >
                          ...
                          <div className="flex flex-col md:flex-row gap-4">
                            <div className="flex-1 flex flex-col gap-1.5">
                              <label className="text-slate-700 text-sm font-google font-bold">Which area are you comfortable mentoring? *</label>
                              <select
                                name="comfortableArea"
                                value={formData.comfortableArea}
                                onChange={handleInputChange}
                                className={`px-4 py-3 rounded-xl border bg-white/70 text-slate-800 font-google-text text-sm focus:outline-none focus:border-[#5746e3] focus:ring-1 focus:ring-[#5746e3]/20 transition-all ${
                                  errors.comfortableArea ? 'border-red-500 focus:border-red-500' : 'border-black/10'
                                }`}
                              >
                            ...
                            <div className="flex-1 flex flex-col gap-1.5">
                              <label className="text-slate-700 text-sm font-google font-bold">Have you mentored a hackathon before? *</label>
                              <div className="flex gap-6 mt-2.5">
                                <label className="flex items-center gap-2 text-sm text-slate-700 cursor-pointer">
                                  <input
                                    ...
                                    onChange={handleInputChange}
                                    className="w-4 h-4 accent-[#5746e3]"
                                  />
                                  Yes
                                </label>
                                <label className="flex items-center gap-2 text-sm text-slate-700 cursor-pointer">
                              ...
                              {errors.mentoredBefore && <span className="text-red-500 text-xs mt-1">{errors.mentoredBefore}</span>}
                            </div>
                          </div>

                          {formData.mentoredBefore === 'Yes' && (
                            <div className="flex flex-col gap-1.5">
                              <label className="text-slate-700 text-sm font-google font-bold">Which hackathons have you mentored?</label>
                              <input
                                type="text"
                                name="mentoredHackathons"
                                value={formData.mentoredHackathons}
                                onChange={handleInputChange}
                                ...
                                return (
                                  <label
                                    ...
                                    className={`flex items-center gap-3 px-4 py-2.5 rounded-xl border text-sm transition-all cursor-pointer ${
                                      isChecked
                                        ? 'bg-[#5746e3]/10 border-[#5746e3] text-[#0C3C34] font-bold'
                                  ...
                                  >
                                    <input
                                      ...
                                      className="w-4 h-4 accent-[#5746e3] cursor-pointer"
                                    />
                                    {opt}
                                  </label>
                                );
                          ...
                          <div className="flex flex-col gap-1.5">
                            ...
                            <textarea
                              ...
                              onChange={handleInputChange}
                              rows={3}
                              placeholder="Tell us a little bit about yourself, your skills, or what you hope to help builders with."
                              className="px-4 py-3 rounded-xl border border-black/10 bg-white/70 text-slate-800 placeholder-slate-400 font-google-text text-sm focus:outline-none focus:border-[#5746e3] focus:ring-1 focus:ring-[#5746e3]/20 transition-all resize-none"
                            />
                          </div>
                        </div>
                      )}
                      ...
                      {step === 3 && (
                        ...
                        <div className="flex flex-col gap-4 overflow-y-auto max-h-[420px] pr-2">
                          ...
                          <div className="flex flex-col md:flex-row gap-4">
                            <div className="flex-1 flex flex-col gap-1.5">
                              <label className="text-slate-700 text-sm font-google font-bold">Traveling from (State or Province) *</label>
                              <input
                                type="text"
                                name="travelingFrom"
                                ...
                                className={`px-4 py-3 rounded-xl border bg-white/70 text-slate-800 placeholder-slate-400 font-google-text text-sm focus:outline-none focus:border-[#5746e3] focus:ring-1 focus:ring-[#5746e3]/20 transition-all ${
                                  errors.travelingFrom ? 'border-red-500 focus:border-red-500 focus:ring-red-200' : 'border-black/10'
                                }`}
                              />
                            ...
                            <div className="flex-1 flex flex-col gap-1.5">
                              ...
                              <select
                                ...
                                onChange={handleInputChange}
                                className={`px-4 py-3 rounded-xl border bg-white/70 text-slate-800 font-google-text text-sm focus:outline-none focus:border-[#5746e3] focus:ring-1 focus:ring-[#5746e3]/20 transition-all ${
                                  errors.tShirtSize ? 'border-red-500 focus:border-red-500' : 'border-black/10'
                                }`}
                              >
                          ...
                          <div className="flex flex-col gap-1.5 mt-2">
                            ...
                            {formData.resumeUrl ? (
                              ...
                              <div className="flex items-center justify-between p-4 rounded-xl border border-[#5746e3]/30 bg-[#5746e3]/5 transition-all">
                                <div className="flex items-center gap-3">
                                  <div className="w-10 h-10 rounded-lg bg-[#5746e3]/15 flex items-center justify-center text-[#5746e3]">
                              ...
                              <div className="flex flex-col items-center justify-center py-6 rounded-xl border border-[#5746e3]/30 bg-[#5746e3]/5 gap-2.5">
                                <FontAwesomeIcon icon={faSpinner} className="text-2xl text-[#5746e3] animate-spin" />
                              ...
                              <div
                                ...
                                className={`border-2 border-dashed rounded-xl py-6 flex flex-col items-center justify-center gap-2 cursor-pointer transition-all bg-white/70 hover:bg-white hover:border-[#5746e3]/50 ${
                                  isDragging ? 'border-[#5746e3] bg-[#5746e3]/5' : 'border-black/10'
                                }`}
                              >
                                <input
                                  type="file"
                                  ...
                                  className="hidden"
                                />
                                <div className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-400 group-hover:text-[#5746e3] transition-colors">
                                  <FontAwesomeIcon icon={faUpload} />
                                </div>
                                <div className="text-center px-4">
                                  <span className="text-xs text-slate-700 font-bold block">
                                    Drag & drop resume or <span className="text-[#5746e3] underline">Browse</span>
                                  </span>
                            ...
                            {uploadError && <span className="text-red-500 text-[11px] font-medium mt-0.5">{uploadError}</span>}
                            {errors.resumeUrl && !uploadError && <span className="text-red-500 text-xs mt-0.5">{errors.resumeUrl}</span>}
                          </div>

                          {/* Agreements Section */}
                          <div className="flex flex-col gap-3 mt-4 border-t border-black/5 pt-4">
                            <h3 className="text-sm font-google font-bold text-[#0C3C34]">
                              Mentor Code of Conduct
                            </h3>
                            <div className="flex flex-col gap-2">
                              {conductWaiverPoints.map((point) => {
                                const isChecked = formData.conductWaivers.includes(point);
                                return (
                                  <label key={point} className="flex items-start gap-3 text-xs text-slate-650 cursor-pointer select-none leading-relaxed">
                                    <input
                                      type="checkbox"
                                      checked={isChecked}
                                      onChange={() => handleConductWaiverChange(point)}
                                      className="w-4 h-4 mt-0.5 accent-[#5746e3] cursor-pointer"
                                    />
                                    <span>{point}</span>
                                  </label>
                                );
                              })}
                              {errors.conductWaivers && <span className="text-red-500 text-[10px] font-medium block mt-1">{errors.conductWaivers}</span>}
                            </div>
                          </div>

                          <div className="flex flex-col gap-3 mt-4 border-t border-black/5 pt-4">
                            <h3 className="text-sm font-google font-bold text-[#0C3C34]">
                              MLH Policies & Agreements
                            </h3>
                            <div className="flex flex-col gap-2">
                              {mlhWaiverPoints.map((point) => {
                                const isChecked = formData.mlhWaivers.includes(point);
                                return (
                                  <label key={point} className="flex items-start gap-3 text-xs text-slate-655 cursor-pointer select-none leading-relaxed">
                                    <input
                                      type="checkbox"
                                      checked={isChecked}
                                      onChange={() => handleMlhWaiverChange(point)}
                                      className="w-4 h-4 mt-0.5 accent-[#5746e3] cursor-pointer"
                                    />
                                    <span>{point}</span>
                                  </label>
                              ...
                              {errors.mlhWaivers && <span className="text-red-500 text-[10px] font-medium block mt-1">{errors.mlhWaivers}</span>}
                            </div>
                          </div>
                        </div>
                      )}
                ...
                {/* Buttons Navigation */}
                <div className="flex justify-between items-center mt-10 pt-6 border-t border-black/5 select-none">
                  <button
                    type="button"
                    onClick={handleBack}
                  ...
                  {step < steps.length ? (
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 bg-[#5746e3] hover:bg-[#5746e3]/95 text-white font-google font-bold px-7 py-3 rounded-full transition-all cursor-pointer hover:shadow-lg active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                      {isSubmitting ? (
                        <>
              ...
              <div className="flex justify-between items-center px-4 py-1.5 bg-[#0C3C34] text-white font-google-mono text-[10px] select-none">
                <div className="flex items-center gap-3">
                  ...
                  <span className="opacity-80">Mentor application pipeline ready</span>
                </div>
                <div className="flex items-center gap-3 font-google-mono">
                  <span>Ln {step * 15}, Col 12</span>
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1, y: 0 }}
              transition={{ duration: 0.8, ease: spring }}
              className="bg-white/45 backdrop-blur-xl rounded-2xl border border-white/25 shadow-2xl p-8 sm:p-12 text-center"
            >
              <div className="w-16 h-16 bg-[#5746e3]/10 text-[#5746e3] rounded-full flex items-center justify-center mx-auto mb-6 text-2xl">
                <FontAwesomeIcon icon={faCheck} />
              </div>
              <h2 className="text-3xl font-google font-bold text-[#0C3C34] mb-4">
                Thank You for Applying!
              </h2>
              <p className="text-slate-705 font-google-text text-sm max-w-md mx-auto leading-relaxed mb-8">
                Your mentor application has been successfully submitted to the HackGB team. We will review your background and get in touch with you shortly.
              </p>
              <button
                onClick={() => navigate('/')}
                className="px-6 py-3 bg-[#0C3C34] hover:bg-[#0C3C34]/95 text-white font-google font-bold rounded-full text-sm transition-all hover:scale-[1.02] cursor-pointer"
              >
                Back to Home
              </button>
            </motion.div>
